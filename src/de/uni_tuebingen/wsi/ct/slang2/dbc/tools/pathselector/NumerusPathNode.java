...
/**
 * Ein Dialog, um einen Pfad anzuzeigen und auszuw�hlen.
 * 
 * @author Volker Kl�bb extended by Thomas M�ller
 */
public class NumerusPathNode extends JComponent
      implements
         TreeSelectionListener,
         ActionListener {

	/**
	 * TODO: die filter-options einf�gen????
	 */
   ...
   /**
    * Erstellt einen Dialog, um Pfade auszuw�hlen.
    * 
    * @param server
    *        Die URL des Server
    * @throws DBC_ConnectionException
    */
   public NumerusPathNode(String server) throws Exception {
   ...
   /**
    * Gibt die ID des selektierten Pfades zur�ck
    */
