...
Serializable {
	...
	private boolean startsParagraph;
	private boolean startsNewline;

	/**
	 * Wird vom DBC benötigt
	 */
	IllocutionUnit(int id, Chapter chapter, int index, int start, int end, boolean startsParagraph, boolean startsNewline ) {
		this.id = id;
	...
	public boolean isStartsParagraph( )
	{
		return startsParagraph;
	}

	public void setStartsParagraph( boolean startsParagraph )
	{
		this.startsParagraph = startsParagraph;
	}

	public boolean isStartsNewline( )
	{
		return startsNewline;
	}

	public void setStartsNewline( boolean startsNewline )
	{
		this.startsNewline = startsNewline;
	}
	 ...
	 * Wird vom DBC benötigt
	 */
	IllocutionUnit(int id, Chapter chapter, int index, int start, int end, String kriterium, boolean startsParagraph, boolean startsNewline ) {
		this.id = id;
		this.chapter = chapter;
		this.index = index;
		this.start = start;
