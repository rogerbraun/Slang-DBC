 ...
 * 
 */
public class OldDialogSpeakerChange extends DB_Element {
    ...
    * 
    */
   public OldDialogSpeakerChange(DBC_Key key,
         int id,
         Dialog dialog,
         int speakerChange,
         int index,
   ...
   OldDialogSpeakerChange(Dialog dialog, int speakerChange, int index) {
      super(-1);
      this.dialog = dialog;
      this.speakerChange = speakerChange;
      this.index = index;
