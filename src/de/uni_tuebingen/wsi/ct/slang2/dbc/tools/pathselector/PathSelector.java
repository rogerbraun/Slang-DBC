 ...
 * @author Volker Klöbb
 */
public class PathSelector extends JComponent
      implements
    ...
    */
   public PathSelector(String server) throws Exception {
      DBC dbc = new DBC(server);
      rootPath = dbc.getPaths();
      dbc.close();
   }
   ...
   private JDialog createDialog(Frame parent, int nodeID) {
      ...
      sp1.setBorder(new TitledBorder("Paths"));
