...
public class Dialog extends DB_Element
   ...
   /**
    * Konstruktor fï¿½r neu angelegte Dialoge, die noch keine ID erhalten haben
    * 
    * @param chapter
    *        Das Kapitel, in dem der Dialog vorkommt
    * @param index
   ...
   /**
    * Konstruktor fï¿½r neu angelegte Dialoge, die noch keine ID von der
   ...
   /**
    * Prï¿½ft, ob dieser Dialog schon akzeptiert wurde
    */
   ...
   /**
    * ï¿½ndert den Index des Dialoges innerhalb des Kapitels. Dabei dï¿½rfen
    * keine Dialoge mit gleichem Index vorkommen. Falls doch, wird spï¿½testens
   ...
   /**
    * Gibt alle Tokens in einem Vektor zurï¿½ck, die in diesem Dialog vorkommen.
    * 
   ...
   /**
    * Gibt die Indizies der Tokens zurï¿½ck, die in diesem Dialog vorkommen.
    * 
   ...
   /**
    * Gibt alle Tokens in einem Vektor zurï¿½ck, die in dem Vorfeld des Dialog
    * vorkommen.
    * 
    * @return Vector mit Tokens
    */
   ...
   /**
    * Gibt die Indizies der Tokens zurï¿½ck, die in dem Vorfeld von diesem
    * Dialog vorkommen.
    * 
    * @return int-Array mit Token-Indizies.
    */
   ...
   /**
    * Gibt alle Tokens in einem Vektor zurï¿½ck, die in dem Nachfeld des Dialog
    * vorkommen.
    * 
    * @return Vector mit Tokens
    */
   ...
   /**
    * Gibt die absoluten Positionen der Tokens zurï¿½ck, die in dem Nachfeld von
   ...
   /**
    * Fï¿½llt den Dialog neu. Der alte Dialog wird dabei ersetzt. Wichtig ist
    * hierbei der erste und letzte Eintrag in dem Array. Es wird angenommen, das
    * der Array eine durchgehende Folge von Tokenpositionen ohne Lï¿½cke
    * speichert.
    * 
    * @param positions
   ...
   /**
    * Fï¿½llt das Vorfeld neu. Das alte Vorfeld wird dabei ersetzt. Wichtig ist
    * hierbei der erste und letzte Eintrag in dem Array. Es wird angenommen, das
    * der Array eine durchgehende Folge von Tokenpositionen ohne Lï¿½cke
    * speichert.
    * 
   ...
   /**
    * Fï¿½llt das Nachfeld neu. Das alte Nachfeld wird dabei ersetzt. Wichtig
    * ist hierbei der erste und letzte Eintrag in dem Array. Es wird angenommen,
    * das der Array eine durchgehende Folge von Tokenpositionen ohne Lï¿½cke
    * speichert.
    * 
    * @param positions
    ...
    * ï¿½uï¿½erungseinheit gewï¿½hlt, in der dieser Token vorkommt.
    * 
    * @param token
    *        der neue Starttoken.
    ...
    * 
    * @param iu
    *        die ï¿½uï¿½erungseinheit, die den Start von diesem Dialog bildet
    */
    ...
    * ï¿½uï¿½erungseinheit gewï¿½hlt, die diesen Index abdeckt.
    * 
    * @param index
    ...
    * ï¿½uï¿½erungseinheit gesetzt, in der dieser Token vorkommt.
    * 
    * @param token
    *        der neue Endtoken.
    ...
    * 
    * @param iu
    *        Die ï¿½uï¿½erungseinheit, die das neue Ende von diesem Dialog
    *        bilden soll.
    */
    ...
    * wird aber die entsprechende ï¿½uï¿½erungseinheit gewï¿½hlt, die diesen
    * Index beinhaltet.
    * 
    * @param index
    ...
    * entsprechende ï¿½uï¿½erungseinheit gewï¿½hlt, die diesen Index beinhaltet.
    * 
    * @param index
    ...
    * 
    * @param iu
    *        Die ï¿½uï¿½erungseinheit, die den Start des Vorfeldes darstellen
    *        soll.
    */
    ...
    * ï¿½uï¿½erungseinheit als Start gewï¿½hlt, in der dieser Token vorkommt.
    * 
    * @param token
    */
   ...
   /**
    * Setzt die Endposition des Vorfelds. Als Ende wird die ï¿½uï¿½erungseinheit
    * gewï¿½hlt, die diesen Index abdeckt.
    * 
    * @param index
    *        die Endposition als Index eines Tokens
    */
    ...
    * 
    * @param iu
    *        Die ï¿½uï¿½erungseinheit, die das Ende des Vorfelds darstellen
    *        soll.
    */
    ...
    * ï¿½uï¿½erungseinheit, in der dieser Token vorkommt.
    * 
    * @param token
    */
    ...
    * ï¿½uï¿½erungseinheit gespeichert, in der dieser Index vorkommt.
    * 
    * @param index
    ...
    * 
    * @param iu
    *        Die ï¿½uï¿½erungseinheit, die den neuen Start des Nachfelds bilden
    *        soll.
    */
   ...
   /**
    * Setzt den Start des Nachfelds. Intern wird aber die ï¿½uï¿½erungseinheit
    ...
    * 
    * @param iu
    *        Die ï¿½uï¿½erungseinheit, die das neue Ende des Nachfelds bilden
    *        soll.
    */
   ...
   /**
    * Setzt das Ende des Nachfelds. Intern wird dabei die ï¿½uï¿½erungseinheit
   ...
   /**
    * Prï¿½ft, ob dieser Dialog die Zeichenposition abdeckt.
    * 
    * @param position
    *        die zu ï¿½berprï¿½fende Zeichenposition
   ...
   /**
    * Prï¿½ft, ob der Token in dem Dialog vorkommt.
    * 
    * @param token
    *        der zu prï¿½fende Token
    */
   ...
   /**
    * Prï¿½ft, ob der Token in dem Vorfeld vorkommt.
    * 
    * @param token
    *        der zu prï¿½fende Token
    */
   ...
   /**
    * Prï¿½ft, ob der Token in dem Nachfeld vorkommt.
    * 
    * @param token
    *        der zu prï¿½fende Token
    */
   ...
   /**
    * Prï¿½ft, ob der Token in dem Dialog oder in dem Vorfeld oder in dem
    * Nachfeld vorkommt.
    * 
    * @param token
    *        der zu prï¿½fende Token
   ...
   /**
    * Prï¿½ft, ob diese ï¿½uï¿½erungseinheit in dem Dialog oder in dem Vorfeld
    * oder in dem Nachfeld vorkommt.
    * 
    * @param iu
    *        die zu prï¿½fende ï¿½uï¿½erungseinheit
    */
   ...
   /**
    * Prï¿½ft, ob diese direkte Rede in dem Dialog vorkommt
    * 
    * @param speech
    *        die zu ï¿½berprï¿½fende direkte Rede
    */
   ...
   /**
    * Prï¿½ft, ob diese ï¿½uï¿½erungseinheit in dem Dialog vorkommt.
    * 
    * @param iu
    *        die zu prï¿½fende ï¿½uï¿½erungseinheit
    */
   ...
   /**
    * Prï¿½ft, ob diese ï¿½uï¿½erungseinheit in dem Vorfeld vorkommt.
    * 
    * @param iu
    *        die zu prï¿½fende ï¿½uï¿½erungseinheit
    */
   ...
   /**
    * Prï¿½ft, ob diese ï¿½uï¿½erungseinheit in dem Nachfeld vorkommt.
    * 
    * @param iu
    *        die zu prï¿½fende ï¿½uï¿½erungseinheit
    */
   ...
   /**
    * Die letzte ï¿½uï¿½erungseinheit des Dialogs
    */
   ...
   /**
    * Die erste ï¿½uï¿½erungseinheit des Dialogs.
    */
   ...
   /**
    * Die letzte ï¿½uï¿½erungseinheit des Nachfelds
    */
   ...
   /**
    * Die erste ï¿½uï¿½erungseinheit des Nachfelds
    */
   ...
   /**
    * Die letzte ï¿½uï¿½erungseinheit des Vorfelds
    */
   ...
   /**
    * Die erste ï¿½uï¿½erungseinheit des Vorfelds
    */
   ...
   /**
    * Gibt das Vorfeld des Dialogs zurï¿½ck. Hilfreich fï¿½r die Speicherung von
    * Kommentaren.
    */
   ...
   /**
    * Gibt das Nachfeld des Dialogs zurï¿½ck. Hilfreich fï¿½r die Speicherung
    * von Kommentaren.
    */
   ...
   /**
    * Prï¿½ft, ob schon ein Vorfeld zu diesem Dialog angegeben wurde.
    */
   ...
   /**
    * Prï¿½ft, ob schon ein Nachfeld zu diesem Dialog angegeben wurde.
    * 
    */
   ...
   /**
    * Gibt den Dialog als String zurï¿½ck (Testausgabe)
    */
