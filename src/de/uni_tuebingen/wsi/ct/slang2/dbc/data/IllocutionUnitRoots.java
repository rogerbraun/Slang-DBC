...
public class IllocutionUnitRoots
   ...
   private Vector<IllocutionUnitRoot>            roots;
    ...
    */
   public IllocutionUnitRoots(DBC_Key key, Chapter chapter, Vector<IllocutionUnitRoot> roots) {
      key.unlock();
    ...
    */
   public Vector<IllocutionUnitRoot> getRoots() {
      return roots;
   }
    ...
    */
   public Vector<ConstitutiveWord> getConstitutiveWords() {
      Vector<ConstitutiveWord> res = new Vector<ConstitutiveWord>();
      for (int i = 0; i < roots.size(); i++) {
         IllocutionUnitRoot root = (IllocutionUnitRoot) roots.get(i);
    ...
    * Wird vom DBC benötigt.
    */
   public Vector<ConstitutiveWord> getConstitutiveWords(DBC_Key key) {
      key.unlock();
      Vector<ConstitutiveWord> res = new Vector<ConstitutiveWord>();
      for (int i = 0; i < roots.size(); i++) {
         IllocutionUnitRoot root = (IllocutionUnitRoot) roots.get(i);
    ...
    */
   public Vector<FunctionWord> getFunctionWords() {
      Vector<FunctionWord> res = new Vector<FunctionWord>();
      for (int i = 0; i < roots.size(); i++) {
         IllocutionUnitRoot root = (IllocutionUnitRoot) roots.get(i);
